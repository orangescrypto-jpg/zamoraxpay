...
async function getToken(baseUrl: string, credentials: VtuProviderCredentials): Promise<string | null> {
  const username = credentials.username || process.env.VTUNG_USERNAME
