...
export const SPIN_SOURCE_DEFAULTS: SpinSourceDefault[] = [
  ...
  { key: "scratch_card", label: "Scratch card (daily free scratch)", description: "A free scratch card every day with no purchase or streak needed. Reappears the next day while switched on.", isEnabled: false, ticketsPerAward: 1, spinsPerDay: 1, expiryMode: "end_of_day", expiryHours: 24, dailyBudgetKobo: 200000, guaranteeAfterLosses: 8, config: {} },
  { key: "pick_a_card", label: "Pick a card (daily free pick)", description: "A free pick-a-card every day with no purchase or streak needed. Pick one of 4 face-down cards to reveal a prize. Reappears the next day while switched on.", isEnabled: false, ticketsPerAward: 1, spinsPerDay: 1, expiryMode: "end_of_day", expiryHours: 24, dailyBudgetKobo: 200000, guaranteeAfterLosses: 8, config: {} },
  { key: "mystery_box", label: "Mystery box on purchase", description: "A mystery box for each successful purchase at or above the minimum amount.", isEnabled: false, ticketsPerAward: 1, spinsPerDay: 2, expiryMode: "end_of_day", expiryHours: 24, dailyBudgetKobo: 300000, guaranteeAfterLosses: 6, config: {"min_amount_kobo": 100000} },
]
...
export const SPIN_DEFAULT_PRIZES: SpinDefaultPrize[] = [
  ...
  { id: "seed-scratch_card-1", sourceKey: "scratch_card", label: "Better luck next time", prizeType: "nothing", amountKobo: 0, discountPercent: 0, maxDiscountKobo: 0, weight: 55, costKobo: 0, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#0F1E4D", sortOrder: 1 },
  { id: "seed-scratch_card-2", sourceKey: "scratch_card", label: "₦10 credit", prizeType: "wallet_credit", amountKobo: 1000, discountPercent: 0, maxDiscountKobo: 0, weight: 30, costKobo: 1000, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: true, isJackpot: false, color: "#2563EB", sortOrder: 2 },
  { id: "seed-scratch_card-3", sourceKey: "scratch_card", label: "₦25 credit", prizeType: "wallet_credit", amountKobo: 2500, discountPercent: 0, maxDiscountKobo: 0, weight: 10, costKobo: 2500, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#7C3AED", sortOrder: 3 },
  { id: "seed-scratch_card-4", sourceKey: "scratch_card", label: "₦50 credit", prizeType: "wallet_credit", amountKobo: 5000, discountPercent: 0, maxDiscountKobo: 0, weight: 4, costKobo: 5000, maxWinsPerDay: 5, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#0891B2", sortOrder: 4 },
  { id: "seed-scratch_card-5", sourceKey: "scratch_card", label: "5% off next purchase", prizeType: "discount", amountKobo: 0, discountPercent: 5, maxDiscountKobo: 5000, weight: 1, costKobo: 5000, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#059669", sortOrder: 5 },
  { id: "seed-pick_a_card-1", sourceKey: "pick_a_card", label: "Better luck next time", prizeType: "nothing", amountKobo: 0, discountPercent: 0, maxDiscountKobo: 0, weight: 55, costKobo: 0, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#0F1E4D", sortOrder: 1 },
  { id: "seed-pick_a_card-2", sourceKey: "pick_a_card", label: "₦10 credit", prizeType: "wallet_credit", amountKobo: 1000, discountPercent: 0, maxDiscountKobo: 0, weight: 30, costKobo: 1000, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: true, isJackpot: false, color: "#2563EB", sortOrder: 2 },
  { id: "seed-pick_a_card-3", sourceKey: "pick_a_card", label: "₦25 credit", prizeType: "wallet_credit", amountKobo: 2500, discountPercent: 0, maxDiscountKobo: 0, weight: 10, costKobo: 2500, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#7C3AED", sortOrder: 3 },
  { id: "seed-pick_a_card-4", sourceKey: "pick_a_card", label: "₦50 credit", prizeType: "wallet_credit", amountKobo: 5000, discountPercent: 0, maxDiscountKobo: 0, weight: 4, costKobo: 5000, maxWinsPerDay: 5, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#0891B2", sortOrder: 4 },
  { id: "seed-pick_a_card-5", sourceKey: "pick_a_card", label: "5% off next purchase", prizeType: "discount", amountKobo: 0, discountPercent: 5, maxDiscountKobo: 5000, weight: 1, costKobo: 5000, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#059669", sortOrder: 5 },
  { id: "seed-mystery_box-1", sourceKey: "mystery_box", label: "Better luck next time", prizeType: "nothing", amountKobo: 0, discountPercent: 0, maxDiscountKobo: 0, weight: 50, costKobo: 0, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#0F1E4D", sortOrder: 1 },
  { id: "seed-mystery_box-2", sourceKey: "mystery_box", label: "₦15 credit", prizeType: "wallet_credit", amountKobo: 1500, discountPercent: 0, maxDiscountKobo: 0, weight: 28, costKobo: 1500, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: true, isJackpot: false, color: "#2563EB", sortOrder: 2 },
  { id: "seed-mystery_box-3", sourceKey: "mystery_box", label: "₦40 credit", prizeType: "wallet_credit", amountKobo: 4000, discountPercent: 0, maxDiscountKobo: 0, weight: 12, costKobo: 4000, maxWinsPerDay: 0, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#7C3AED", sortOrder: 3 },
  { id: "seed-mystery_box-4", sourceKey: "mystery_box", label: "₦100 credit", prizeType: "wallet_credit", amountKobo: 10000, discountPercent: 0, maxDiscountKobo: 0, weight: 6, costKobo: 10000, maxWinsPerDay: 3, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: false, color: "#0891B2", sortOrder: 4 },
  { id: "seed-mystery_box-5", sourceKey: "mystery_box", label: "₦500 JACKPOT box", prizeType: "wallet_credit", amountKobo: 50000, discountPercent: 0, maxDiscountKobo: 0, weight: 1, costKobo: 50000, maxWinsPerDay: 1, maxWinsPerWeek: 0, isGuaranteePrize: false, isJackpot: true, color: "#D97706", sortOrder: 5 },
]
